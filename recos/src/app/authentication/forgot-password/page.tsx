    ...
    <div className="relative bg-[#141244] h-screen w-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-20 bg-[#FFF7F9] flex flex-col md:flex-row w-full max-w-7xl h-[730px] overflow-auto">
        <div className="flex flex-col justify-start p-8 md:p-16 md:w-1/2">
          ...
          <h2 className="text-[#8645E8] font-bold text-2xl mt-10 mb-10 ml-20 select-none">
            Forgot Password
          </h2>
          <p className="font-semibold text-[#24184E] text-[16px] mb-10">
            Enter the email associated with your account and we&apos;ll send a verification code.
          </p>
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <label htmlFor="email" className="block font-semibold mb-1 text-[#24184E] text-[15px]">
              Email
            </label>
            <input
              id="email"
              ...
              required
              className="w-full border rounded-md py-2 px-3 outline-none text-[15px] text-black bg-white"
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-[#8645E8] text-white rounded-full py-2 px-12 text-base font-semibold mt-20 ml-25 w-fit mx-auto hover:bg-[#7A3BD1] transition cursor-pointer"
            >
